...
public class OpenAIComparisonService implements ComparisonService {
    ...
    public String compareVideoSnapsById(Long id1, Long id2) throws IOException {
        ...
        return openAIService.compareImages(PatternUtil.stripBase64DataUriPrefix(snapData.earlierData()), PatternUtil.stripBase64DataUriPrefix(snapData.laterData()));
    }
    ...
    protected record SnapData(String earlierData, String laterData) {
    }
